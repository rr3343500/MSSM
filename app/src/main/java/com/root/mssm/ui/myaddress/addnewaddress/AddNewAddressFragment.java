package com.root.mssm.ui.myaddress.addnewaddress;
...
public class AddNewAddressFragment extends Fragment  implements SelectStateCity , CurrentLocation {

    private AddNewAddressViewModel mViewModel;
    private AddNewAddressFragmentBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = AddNewAddressFragmentBinding.inflate(inflater, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(AddNewAddressViewModel.class);
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        cookies= new Cookies();
        binding.topPanel.title.setText("Add New Address");
...
//        binding.house.setText(location.get(0).getAddressLine().toString());
    ...
    void SaveAddress(){
        ...
        chinniInterface.ADD_NEW_ADDRESS(jsonObject).enqueue(new Callback<AddNewAddress>() {
            @Override
