...
import com.root.mssm.List.List.subcatproduct.Subcategoryprod;
...
public class AdapterSubCatProducts extends RecyclerView.Adapter<AdapterSubCatProducts.MyViewHolder> {
    Context context;
    List<Subcategoryprod> categories = new ArrayList<>();

    public AdapterSubCatProducts(List<Subcategoryprod> categories) {
