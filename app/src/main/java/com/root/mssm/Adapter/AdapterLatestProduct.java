...
import com.root.mssm.List.List.home.Latestprod;
import com.root.mssm.R;
import com.root.mssm.databinding.RowBestProductBinding;
import com.root.mssm.databinding.RowLatestProductBinding;
import com.root.mssm.service.Config;

import java.util.ArrayList;
import java.util.List;

public class AdapterLatestProduct extends RecyclerView.Adapter<AdapterLatestProduct.MyViewHolder> {
    Context context;
    List<Latestprod> categories = new ArrayList<>();

    public AdapterLatestProduct(List<Latestprod> categories) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyViewHolder(RowLatestProductBinding.inflate(LayoutInflater.from(parent.getContext()) , parent , false));
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        RowLatestProductBinding binding;

        public MyViewHolder(@NonNull RowLatestProductBinding itemView) {
