...
import com.root.mssm.List.List.home.Hotprod;
import com.root.mssm.R;
import com.root.mssm.databinding.RowBestProductBinding;
import com.root.mssm.databinding.RowHotProductsBinding;
import com.root.mssm.service.Config;

import java.util.ArrayList;
import java.util.List;

public class AdapterHotProducts  extends RecyclerView.Adapter<AdapterHotProducts.MyViewHolder> {
    Context context;
    List<Hotprod> categories = new ArrayList<>();

    public AdapterHotProducts(List<Hotprod> categories) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyViewHolder(RowHotProductsBinding.inflate(LayoutInflater.from(parent.getContext()) , parent , false));
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.binding.disc.setText(categories.get(position).getMetaDescription());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        RowHotProductsBinding binding;

        public MyViewHolder(@NonNull RowHotProductsBinding itemView) {
