...
import com.root.mssm.List.List.superproducts.Superprod;
...
public class AdapterSuperProduct  extends RecyclerView.Adapter<AdapterSuperProduct.MyViewHolder> {
    Context context;
    List<Superprod> categories = new ArrayList<>();

    public AdapterSuperProduct(List<Superprod> categories) {
