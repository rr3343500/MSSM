...
import com.root.mssm.List.List.maincatproduct.Maincategoryprod;
import com.root.mssm.R;
import com.root.mssm.databinding.RowFeatureProductBinding;
import com.root.mssm.service.Config;

import java.util.ArrayList;
import java.util.List;

public class AdapterMainCatProduct  extends RecyclerView.Adapter<AdapterMainCatProduct.MyViewHolder> {
    Context context;
    List<Maincategoryprod> categories = new ArrayList<>();

    public AdapterMainCatProduct(List<Maincategoryprod> categories) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyViewHolder(RowFeatureProductBinding.inflate(LayoutInflater.from(parent.getContext()) , parent , false));
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        RowFeatureProductBinding binding;

        public MyViewHolder(@NonNull RowFeatureProductBinding itemView) {
