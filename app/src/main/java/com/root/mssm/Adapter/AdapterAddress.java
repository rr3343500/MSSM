...
public class AdapterAddress extends RecyclerView.Adapter<AdapterAddress.MyViewHolder> {
    ...
    public AdapterAddress(List<AddressData> categories) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyViewHolder(RowMyaddressLayoutBinding.inflate(LayoutInflater.from(parent.getContext()) , parent , false));
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.binding.action.setOnClickListener(v -> {
            PopupMenu dropDownMenu = new PopupMenu(context.getApplicationContext(), holder.binding.action);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        RowMyaddressLayoutBinding binding;

        public MyViewHolder(@NonNull RowMyaddressLayoutBinding itemView) {
