...
import com.root.mssm.List.List.home.Featuredprod;
...
public class AdapterFeatureProduct  extends RecyclerView.Adapter<AdapterFeatureProduct.MyViewHolder> {
    Context context;
    List<Featuredprod> categories = new ArrayList<>();

    public AdapterFeatureProduct(List<Featuredprod> categories) {
